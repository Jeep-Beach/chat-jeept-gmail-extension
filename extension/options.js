...
class JeepBeachOptions {
  ...
  async loadSettings() {
    try {
      ...
      document.getElementById('jeepBeachUrls').value = settings.jeepBeachUrls || '';
  ...
  async saveSettings() {
    try {
      const settings = {
        ...
        jeepBeachUrls: document.getElementById('jeepBeachUrls').value.trim(),
      ...
      if (!settings.jeepBeachUrls) {
        this.showStatus('JeepBeach URLs are required', 'error');
        return;
      }
  ...
  async refreshCache() {
    ...
    try {
      ...
      if (!settings.jeepBeachUrls) {
        throw new Error('JeepBeach URLs not configured');
      }
      ...
      this.showStatus('Site cache refreshed successfully!', 'success');
  ...
  async resetDefaults() {
    ...
    try {
      ...
      document.getElementById('jeepBeachUrls').value = defaults.jeepBeachUrls;
